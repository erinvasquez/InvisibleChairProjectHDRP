...
using TMPro;
/// <summary>
/// Intended to work with an input manager script that will feed input to this (or the appropriate control script),
/// and control our synthesizer. 
/// 
/// TODO: figure out if we want to handle different synthesizer controls in an options menu,
/// keep it a standard, or base it off of some base control set.
/// </summary>
public class SynthesizerControls : MonoBehaviour {
    ...
    /// </summary>
    /// <param name="key">String name of the key</param>
