...
/// <summary>
/// Unity network Client handler class
/// 
/// Hanldes packet data being sent to the server
/// 
/// Include the packets we'll use in our Packet Class.
/// </summary>
public class ClientHandle : MonoBehaviour {
    
    /// <summary>
    /// Send a welcome received packet to the server and
    /// connect UDP
    /// </summary>
    ...
    /// <summary>
    /// Spawn a player using packet data
    /// </summary>
    /// <param name="_packet"></param>
    ...
    /// <summary>
    /// Set a player's position from a packet
    /// </summary>
    /// <param name="_packet"></param>
    public static void PlayerPosition(Packet _packet) {
        ...
        // Get the player relevant to the ID in the packet
    ...
    /// <summary>
    /// Set a player's rotation from a packet
    /// </summary>
    /// <param name="_packet"></param>
    ...
    /// <summary>
    /// Disconnect a player from packet data
    /// </summary>
    /// <param name="_packet"></param>
