...
/// <summary>
/// Unity network client for InvisibleChairProject
/// </summary>
public class Client : MonoBehaviour {
    ...
    /// <summary>
    /// True if we've connected to a server
    /// </summary>
    private bool isConnected = false;
    private delegate void PacketHandler(Packet _packet);
    /// <summary>
    /// A Dictionary of the packet handlers we have
    /// </summary>
    private static Dictionary<int, PacketHandler> packetHandlers;

    private void Awake() {

        // Take care of our singleton
        if (instance == null) {
            instance = this;
    ...
    public void ConnectToServer() {
        // set our TCP and UCP connections up
        tcp = new TCP();
        udp = new UDP();
    ...
    #region TCP
    /// <summary>
    /// TCP Connection class inside our Client class
    /// </summary>
    public class TCP {
    ...
    /// 
    /// Make sure all our different Server Packets types are included here
    /// 
    /// </summary>
    private void InitializeClientData() {
        // Set our packet handler dictionary
